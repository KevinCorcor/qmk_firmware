...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_89(
        ...
        KC_NO,    KC_NO,    KC_A,     KC_R,     KC_S,     KC_T,     KC_G,      KC_M,     KC_N,     KC_E,      KC_I,      KC_O,       KC_NO,                  KC_NO,                   KC_NO,      
        KC_NO,    KC_NO,              KC_Z,     KC_X,     KC_C,     KC_D,      KC_V,     KC_B,     KC_K,      KC_H,      KC_COMM,    KC_DOT,     KC_SCLN,    KC_NO,      KC_UP,      
        KC_NO,    KC_NO,    KC_TAB,             QK_GESC,  KC_SPC,   LT(3,KC_ENT),                  KC_SPC,               KC_BSPC,                            KC_LEFT,    KC_DOWN,     KC_RGHT
 
        KC_MUTE,  KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_INS,             KC_DEL,
        _______,  KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
        _______,  KC_TAB,   KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,      KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
        _______,  KC_CAPS,  GUI_A,    ALT_R,    SFT_S,    CTL_T,    KC_G,      KC_M,     CTL_N,    SFT_E,    ALT_I,    GUI_O,    KC_QUOT,            KC_ENT,             KC_HOME,
        _______,  KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_D,      KC_V,     KC_K,     KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        _______,  KC_LCTL,  KC_LWIN,            KC_LALT,  KC_SPC,  MO(WIN_FN),                     KC_SPC,             KC_RALT,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_ansi_89(
        ...
        KC_TRNS,    KC_TRNS,    KC_PIPE,   KC_AMPR,   KC_LCBR,   KC_RCBR,   KC_UNDS,   KC_F11,    KC_TRNS,   KC_UP,     KC_TRNS,   KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,                 KC_TRNS,
        KC_TRNS,    KC_TRNS,    KC_HASH,   KC_EXLM,   KC_LPRN,   KC_RPRN,   KC_AT,     KC_HOME,   KC_LEFT,   KC_DOWN,   KC_RGHT,   KC_END,     KC_TRNS,                KC_TRNS,                 KC_TRNS,
        KC_TRNS,    KC_TRNS,               KC_CIRC,   KC_QUES,   KC_LBRC,   KC_RBRC,   KC_DLR,    KC_NO,     KC_NO,     KC_NO,     KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      
        KC_NO,      KC_NO,      KC_NO,                MO(4),     KC_NO,     KC_NO,                           KC_NO,                KC_TRNS,                            KC_NO,      KC_NO,       KC_NO
