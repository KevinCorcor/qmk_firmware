 ...
 */
 ...
 static bool _caps_word_on = false;
 ...
 bool process_case_modes(uint16_t keycode, const keyrecord_t *record) {
     if (_caps_word_on || xcase_state) {
         ...
         if (record->event.pressed) {
             ...
             else if (_caps_word_on && is_alpha_keycode(keycode)){
